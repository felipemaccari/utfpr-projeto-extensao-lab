...
const InstitutionsTableActionsEdit = ({ institution }) => {
              ...
              <Flex direction="column" my="30px">
                ...
                <FormControl isInvalid={errors.tipoInstituicao} mt="30px">
                  ...
                  <Select
                    ...
                    defaultValue={institution.tipoInstituicao}
...
export default InstitutionsTableActionsEdit;
